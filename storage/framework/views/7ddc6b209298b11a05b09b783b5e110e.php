...
<?php echo app('translator')->get('Edit Recipe'); ?>
...
<?php $__env->slot('title'); ?> Edit Recipe <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="card">
        <div class="card-body">
            ...
            <form id="form" data-parsley-validate class="form-horizontal custom-validation" method="POST" action="<?php echo e(route('recipe.update')); ?>" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-10">
                        <input name="title" type="text" class="form-control" id="title" value="<?php echo e($recipe->title); ?>"
                ...
                <div class="mb-3 row">
                    <div class="col-sm-12">
                        ...
                        <a href="<?php echo e(route('recipe.view', ['recipe_id' => $recipe->id])); ?>" class="btn btn-secondary float-end me-2"><?php echo app('translator')->get('button.back'); ?></a>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\user\Documents\GitHub\IresymaBakerySystem\resources\views/Recipe/edit.blade.php ENDPATH**/ ?>