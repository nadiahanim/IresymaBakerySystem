        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <div class="hstack gap-4">
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded d-block mx-auto">
                            <code>.rounded</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded-top d-block mx-auto">
                            <code>.rounded-top</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded-end d-block mx-auto">
                            <code>.rounded-end</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded-bottom d-block mx-auto">
                            <code>.rounded-bottom</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded-start d-block mx-auto">
                            <code>.rounded-start</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-md rounded-circle d-block mx-auto">
                            <code>.rounded-circle</code>
                        </div>
                        <div class="text-center">
                            <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" height="72" class="rounded-pill d-block mx-auto">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-4">
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-0 d-block mx-auto">
                                <code>.rounded-0</code>
                            </div>
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-1 d-block mx-auto">
                                <code>.rounded-1</code>
                            </div>
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-2 d-block mx-auto">
                                <code>.rounded-2</code>
                            </div>
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-3 d-block mx-auto">
                                <code>.rounded-3</code>
                            </div>
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-4 d-block mx-auto">
                                <code>.rounded-4</code>
                            </div>
                            <div class="text-center">
                                <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-md rounded-5 d-block mx-auto">
                                <code>.rounded-5</code>
                            </div>
                        </div>
                    </div>
