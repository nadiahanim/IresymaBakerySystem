...
<div class="row">
    <div class="row mb-2">
        <div class="col-sm-11 offset-sm-1">
            <a type="button" href="<?php echo e(route('faq.create')); ?>" class="btn float-end waves-effect waves-light" style="background-color:#F2A0A0;color:white;">Add New</a>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('faq.edit', ['faq_id' => $data->id])); ?>" class="btn btn-soft-warning btn-sm"><i class="mdi mdi-pencil mdi-18px"></i></a>
                                        ...
                                        <form id="delete-form" method="POST" action="<?php echo e(route('faq.delete')); ?>">
                                            ...
                                            <input name="faq_id" type="hidden" class="form-control" id="faq_id" value="<?php echo e($data->id); ?>">
                                        </form>
                                    </td> 
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\user\Documents\GitHub\IresymaBakerySystem\resources\views/Faq/index.blade.php ENDPATH**/ ?>