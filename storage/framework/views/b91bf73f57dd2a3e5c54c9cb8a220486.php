                        ...
                        <table class="table align-middle table-nowrap table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/build/images/users/avatar-2.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/build/images/users/avatar-3.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/build/images/users/avatar-4.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div>
                                            <img class="rounded-circle avatar-xs" src="<?php echo e(URL::asset('/build/images/users/avatar-5.jpg')); ?>"
                                                alt="">
                                        </div>
                                    </td>
                                    <td>
