...
<div class="row">
    <div class="card">
        <div class="card-body">
                ...
                <?php if($order->order_status == 4 && $order->review == 1): ?>
                <br>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-10">                   
                        <div class="rating-star">
                            <input type="hidden" class="rating" name="overall_stars" value="<?php echo e($review->overall_stars); ?>" data-filled="mdi mdi-heart text-danger" data-empty="mdi mdi-heart-outline text-danger" disabled/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-10">                   
                        <div class="rating-star">
                            <input type="hidden" class="rating" name="design_stars" value="<?php echo e($review->design_stars); ?>" data-filled="mdi mdi-heart text-danger" data-empty="mdi mdi-heart-outline text-danger" disabled/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-10">                   
                        <div class="rating-star">
                            <input type="hidden" class="rating" name="taste_stars" value="<?php echo e($review->taste_stars); ?>" data-filled="mdi mdi-heart text-danger" data-empty="mdi mdi-heart-outline text-danger" disabled/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-10">                   
                        <div class="rating-star">
                            <input type="hidden" class="rating" name="service_stars" value="<?php echo e($review->service_stars); ?>" data-filled="mdi mdi-heart text-danger" data-empty="mdi mdi-heart-outline text-danger" disabled/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-8">                   
                        <textarea class="form-control" name="comment" rows="4" disabled><?php echo e($review->comment); ?></textarea>
                    </div>
                </div>
                <?php else: ?>
                <?php endif; ?>
