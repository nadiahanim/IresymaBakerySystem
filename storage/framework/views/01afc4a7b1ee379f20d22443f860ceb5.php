    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="<?php echo e(asset('/build/images/users/avatar-profile.png')); ?>"
                    alt="Header Avatar">
...
<?php /**PATH D:\user\Documents\GitHub\IresymaBakerySystem\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>